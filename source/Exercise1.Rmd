...
You have ~45 minutes for this exercise. Then, for the final 10-15 minutes we will rejoin the main zoom channel for a wrap-up. At least 1 member of your team should be prepared to give a 1 minute summary of your group’s work.
...
4. Open up the data (in R, in a text reader, in Excel, wherever you prefer) and get exploring! The data dictionary file is a good place to start.
...
Reporter - when we regroup, the reporter will take the lead in summarizing your group’s discussion/progress. (It might be helpful to get the note taker to send you their notes!)

Diagnostician -  thinks about the problems and limitations of the data/analysis, and how we might combat these.

# Some suggestions/ideas/things to think about:
- You have several pieces of information available to you about each infected herd - how might we combine these and which are more/less informative?
- How could we visualize the data and chains of transmission?
