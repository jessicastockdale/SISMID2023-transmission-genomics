...
# A timed phylogemny for the US flu data
...
If you have time, you could try now building timed phylogenies for the TB and COVID-19 data. In exercise 4, we will be using timed trees to reconstruct transmission. We will be providing these timed trees for you, but if you get this far you could see how different your timed `treedater` trees are from those we provide. 
